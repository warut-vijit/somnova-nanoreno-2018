...
#caroff.ogg = whatever the "car turning off" sound effect is named
#dooropen.ogg
#doorclose.ogg = Club back door closing
#scene5music = various music tracks, which aren't yet delivered. Followed by a general mood or tone.
...
label scene5:
     ...
     "The heavy door swings shut behind me, and the figure whips around."
        ...
        show eris p2_e2 at middleright # With some kind of small, shocked, “jump” animation. 
     ...
     show eris p2 e5 "What the hell, Roman?"
     ...
     show eris p1 default at middleleft # This should be a smooth movement.
     ...
     eris smirk "...Do you seriously live in the past?"
...
“And fail."
     ...
     eris thoughtful "I... don't know. I don't talk about it that much."
     ...
     "Do you really mean that?"
          $ cooperation += 1
          jump scene5cooperation
     "Don’t patronize me."
          $ rivalry += 1
          jump scene5rivalry


label scene5cooperation:
...
label scene5rivalry:
     ...
     eris default "...What are you talking about?"
...
eris “Just like last time, you're being a dick—and from my point of view, it's for absolutely no reason whatsoever."
     ...
     show eris p2 e5 at middleright
