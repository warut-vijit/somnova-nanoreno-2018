...
scene bg club_exterior_night
 
bg club_interior_night
...
(Normal scene that plays when the player has chosen at least two RIVAL options, one of those being the RIVAL choice in Scene 5)
label scene5rivalry choice:
...
show Eris (sad/embarrassed, depending on whichever sprite ends up looking more appropriate for the situation)
 
Eris p1 e1 "Wait! Roman, hold on a second!"
...
Eris "Trust me, I wouldn't have gone and told you if I was. This is strictly the kind of deal I know you could give me a hand with."
 
Roman "Go ahead."


jump scene7afterchoice


(The next scene is for players chose RIVAL for the beginning two choices, but then the COOPERATIVE choice in Scene 5)
label scene5cooperation choice:
...
Eris "Not now Roman. My shift is already over so...."
...
Eris "Wait! Roman, hold on a second!"
...
Eris "I don’t think I would have gone and told you if I was. This is strictly the kind of project I know you could give me a hand with."
...
Eris "Come on, Roman! Quit it! The bet's over, this is no longer a competition! I really want what's best for Arcady, okay?"
...
Eris "So as I was saying, {i}I[/i} still think my idea was good. And since what stopped it from working was infrastructure issues ---"
 
Eris "--- I figured I'll do this business a favor by improving the infrastructure."
 
Show Eris p1 e6
 
Eris "That's not nearly as unrealistic, right? It doesn't have to happen fast and it doesn't have to be anything grandiose."
 
Show Eris p2 e7
 
Eris "Honestly, with what this place has at the moment, basically anything would be an improvement, right?"
...
Eris "Fine, let's be all bitter and blunt:"
...
Eris "I'm in {i}way{/i} over my head here, Roman. I figured since I've shopped for electronics so many times in the past this'll be a breeze, but it turns out that getting and installing all that really serious hardware is a completely different matter."
 
Roman "You don't say."
 
Show Eris p2 e5
 
Eris "Don't give me that smug shit, I'm pissed off enough as it is. I've been bashing my head against that stuff for {i}hours{/i} now and I can't even make heads or tails out of anything. I feel like I'm going nuts. I don't even know what half those specifications are {i}for{/i}."
 
Eris "Like, what in the world is a 'PPS' and why can't we get one? What's the difference between the C and E series'? What's that BPT everyone's talking about? Why do half the forums tell me if I get the F2600 with the DDSX I'll burn this place to the ground, but the other half tells me if I don't everything will go to shit and it won't render? What connects to VK? Why doesn't it say anywhere how to put all those different systems together?"
 
Show Eris p3 e8
 
Eris "It's all Chinese to me. Even the parts that {i}aren't{/i} in Chinese. And I {i}read{/i} Chinese, for fuck's sake!"
...
Eris "You {i}know{/i} that's not what I'm talking about, Roman!"
...
Show Eris p1 e6
Eris "If we work together at this, I know we could end up improving Arcady so that everyone'll benefit. I'll help you in any way I can, I just need you to provide your technical expertise."
 
Show Eris p1 e1
 
Eris "I won't force you if you say 'no'. I swear. No games, no nothing. I'm not your boss anymore."
...
Eris "I know, I know. I'm not asking you to go back there or anything, right? This'll be a simple job for you. You could do it in minutes."
...
Eris "Look, I'm not going to beg you, alright? If you don't want to, I'll do it myself."
...
Eris "Don't ask questions you don't really want me to answer."[a]
...
# Show that time's passing. Use animations, soundtrack, I dunno. Come up with something.
 
bg club_interior_night
 
# (if there's any way to visually hint at this being another night, maybe with slightly different surroundings if we got a few versions of them, or something like that – that'd be helpful)
...
# another timeskip, if you please
...
Eris "Nothing, I just wanted to ask about the transmitters ---"
...
Eris "Seriously? Is that what it's going to be like?"
...
Eris "You never gave me a straight answer, you know?"
...
Eris "Quit with it, won't you? I don't buy that."
...
Eris "'What it's going to be like'? What exactly did I do? Hold you down and waterboard you? It wasn't torture, it was your job. It was reality. {i}Life{/i}."
...
Eris "It's like your doing this on purpose."
 
Show Eris p2 e5
 
Eris "Just to show me up."
...
Eris "You like {i}so{/i} much to act like you give a shit about the most pointless things nobody else does."
...
Eris "You never even bothered to check that when you went and spent money on them. You didn't care about that."
...
# sound of door violently opening
 
Eris "Hope you enjoy your break."
 
# sound of door closing violently
