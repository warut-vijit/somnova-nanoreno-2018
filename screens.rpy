...
##########################################
    ...
    gallery_items = ["game/cg/CG_Whiskey.png", "game/cg/CG_Coop_Laugh.png", "game/cg/CG_Coop_Neutral.png", "game/cg/CG_Coop_Smile.png", "game/cg/CG_Rival_Neutral.png", "game/cg/CG_Rival_NoEris.png", "game/cg/CG_Rival_Smile.png"]
    ...
    use game_menu(_("Extras"), scroll="viewport"):
        ...
        frame background None xpos 10:
            grid gal_rows gal_cols:
                ...
                if next_cg_page > int(len(gallery_items)/gal_cells):
                    $ next_cg_page = 0
                for gal_item in gallery_items:
                    $ i += 1
                    if i <= (cg_page+1)*gal_cells and i>cg_page*gal_cells:
                        add g_cg.make_button(gal_item + " butt", gal_item + " butt", im.Scale("game/images/gallocked.png", thumbnail_x, thumbnail_y), xalign=0.5, yalign=0.5, idle_border=None, background=None, bottom_margin=24)
